...
final case class Vote(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.election.raft.Vote = {
    ...
    def companion = frankenpaxos.election.raft.Vote
}

object Vote extends scalapb.GeneratedMessageCompanion[frankenpaxos.election.raft.Vote] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.election.raft.Vote] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.election.raft.Vote = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.election.raft.Vote] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = frankenpaxos.election.raft.Vote(
    round = 0
  )
  implicit class VoteLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.election.raft.Vote]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.election.raft.Vote](_l) {

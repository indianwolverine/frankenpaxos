...
final case class RepeatedLeaderReconfigurationProto(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.horizontal.RepeatedLeaderReconfigurationProto = {
    ...
    def companion = frankenpaxos.horizontal.RepeatedLeaderReconfigurationProto
}

object RepeatedLeaderReconfigurationProto extends scalapb.GeneratedMessageCompanion[frankenpaxos.horizontal.RepeatedLeaderReconfigurationProto] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.horizontal.RepeatedLeaderReconfigurationProto] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.horizontal.RepeatedLeaderReconfigurationProto = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.horizontal.RepeatedLeaderReconfigurationProto] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = frankenpaxos.horizontal.RepeatedLeaderReconfigurationProto(
    delayMs = 0,
    periodMs = 0
  )
  implicit class RepeatedLeaderReconfigurationProtoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.horizontal.RepeatedLeaderReconfigurationProto]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.horizontal.RepeatedLeaderReconfigurationProto](_l) {

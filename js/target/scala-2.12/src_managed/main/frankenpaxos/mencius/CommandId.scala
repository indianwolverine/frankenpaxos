...
final case class CommandId(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.mencius.CommandId = {
    ...
    def companion = frankenpaxos.mencius.CommandId
}

object CommandId extends scalapb.GeneratedMessageCompanion[frankenpaxos.mencius.CommandId] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.mencius.CommandId] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.mencius.CommandId = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.mencius.CommandId] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = MenciusProto.javaDescriptor.getMessageTypes.get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = MenciusProto.scalaDescriptor.messages(1)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = frankenpaxos.mencius.CommandId(
    clientAddress = _root_.com.google.protobuf.ByteString.EMPTY,
    clientPseudonym = 0,
    clientId = 0
  )
  implicit class CommandIdLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.mencius.CommandId]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.mencius.CommandId](_l) {

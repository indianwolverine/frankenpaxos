...
final case class CommandId(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.multipaxos.CommandId = {
    ...
    def companion = frankenpaxos.multipaxos.CommandId
}

object CommandId extends scalapb.GeneratedMessageCompanion[frankenpaxos.multipaxos.CommandId] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.multipaxos.CommandId] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.multipaxos.CommandId = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.multipaxos.CommandId] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = MultiPaxosProto.javaDescriptor.getMessageTypes.get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = MultiPaxosProto.scalaDescriptor.messages(1)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = frankenpaxos.multipaxos.CommandId(
    clientAddress = _root_.com.google.protobuf.ByteString.EMPTY,
    clientPseudonym = 0,
    clientId = 0
  )
  implicit class CommandIdLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.multipaxos.CommandId]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.multipaxos.CommandId](_l) {

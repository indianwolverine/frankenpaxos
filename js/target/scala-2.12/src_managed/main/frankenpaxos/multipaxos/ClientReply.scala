...
final case class ClientReply(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.multipaxos.ClientReply = {
    ...
    def withCommandId(__v: frankenpaxos.multipaxos.CommandId): ClientReply = copy(commandId = __v)
    def withSlot(__v: _root_.scala.Int): ClientReply = copy(slot = __v)
    ...
    def companion = frankenpaxos.multipaxos.ClientReply
}

object ClientReply extends scalapb.GeneratedMessageCompanion[frankenpaxos.multipaxos.ClientReply] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.multipaxos.ClientReply] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.multipaxos.ClientReply = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.multipaxos.ClientReply] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = MultiPaxosProto.javaDescriptor.getMessageTypes.get(13)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = MultiPaxosProto.scalaDescriptor.messages(13)
  ...
  lazy val defaultInstance = frankenpaxos.multipaxos.ClientReply(
    commandId = frankenpaxos.multipaxos.CommandId.defaultInstance,
    slot = 0,
    result = _root_.com.google.protobuf.ByteString.EMPTY
  )
  implicit class ClientReplyLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.multipaxos.ClientReply]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.multipaxos.ClientReply](_l) {

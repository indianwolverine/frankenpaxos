...
final case class ReadReply(
    commandId: frankenpaxos.multipaxos.CommandId,
    slot: _root_.scala.Int,
    result: _root_.com.google.protobuf.ByteString
    ) extends scalapb.GeneratedMessage with scalapb.Message[ReadReply] with scalapb.lenses.Updatable[ReadReply] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.multipaxos.ReadReply = {
    ...
    def withCommandId(__v: frankenpaxos.multipaxos.CommandId): ReadReply = copy(commandId = __v)
    def withSlot(__v: _root_.scala.Int): ReadReply = copy(slot = __v)
    def withResult(__v: _root_.com.google.protobuf.ByteString): ReadReply = copy(result = __v)
    ...
    def companion = frankenpaxos.multipaxos.ReadReply
}

object ReadReply extends scalapb.GeneratedMessageCompanion[frankenpaxos.multipaxos.ReadReply] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.multipaxos.ReadReply] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.multipaxos.ReadReply = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.multipaxos.ReadReply] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = MultiPaxosProto.javaDescriptor.getMessageTypes.get(25)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = MultiPaxosProto.scalaDescriptor.messages(25)
  ...
  lazy val defaultInstance = frankenpaxos.multipaxos.ReadReply(
    commandId = frankenpaxos.multipaxos.CommandId.defaultInstance,
    slot = 0,
    result = _root_.com.google.protobuf.ByteString.EMPTY
  )
  implicit class ReadReplyLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.multipaxos.ReadReply]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.multipaxos.ReadReply](_l) {

...
final case class LeaderReconfigurationProto(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.matchmakermultipaxos.LeaderReconfigurationProto = {
    ...
    def companion = frankenpaxos.matchmakermultipaxos.LeaderReconfigurationProto
}

object LeaderReconfigurationProto extends scalapb.GeneratedMessageCompanion[frankenpaxos.matchmakermultipaxos.LeaderReconfigurationProto] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.matchmakermultipaxos.LeaderReconfigurationProto] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.matchmakermultipaxos.LeaderReconfigurationProto = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.matchmakermultipaxos.LeaderReconfigurationProto] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = frankenpaxos.matchmakermultipaxos.LeaderReconfigurationProto(
  ...
  implicit class LeaderReconfigurationProtoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.matchmakermultipaxos.LeaderReconfigurationProto]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.matchmakermultipaxos.LeaderReconfigurationProto](_l) {

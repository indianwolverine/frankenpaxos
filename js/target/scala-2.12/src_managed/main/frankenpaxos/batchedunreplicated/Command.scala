...
final case class Command(
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      __size += _root_.com.google.protobuf.CodedOutputStream.computeBytesSize(3, command)
      __size
    }
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      _output__.writeBytes(3, command)
    }
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.batchedunreplicated.Command = {
    ...
    def withCommandId(__v: _root_.scala.Int): Command = copy(commandId = __v)
    ...
    def companion = frankenpaxos.batchedunreplicated.Command
}

object Command extends scalapb.GeneratedMessageCompanion[frankenpaxos.batchedunreplicated.Command] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.batchedunreplicated.Command] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.batchedunreplicated.Command = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.batchedunreplicated.Command] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = BatchedUnreplicatedProto.javaDescriptor.getMessageTypes.get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = BatchedUnreplicatedProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = frankenpaxos.batchedunreplicated.Command(
    clientAddress = _root_.com.google.protobuf.ByteString.EMPTY,
    commandId = 0,
    command = _root_.com.google.protobuf.ByteString.EMPTY
  )
  implicit class CommandLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.batchedunreplicated.Command]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.batchedunreplicated.Command](_l) {

...
final case class Phase2a(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.fastpaxos.Phase2a = {
    ...
    def clearValue: Phase2a = copy(value = None)
    def withValue(__v: _root_.scala.Predef.String): Phase2a = copy(value = Option(__v))
    ...
    def companion = frankenpaxos.fastpaxos.Phase2a
}

object Phase2a extends scalapb.GeneratedMessageCompanion[frankenpaxos.fastpaxos.Phase2a] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.fastpaxos.Phase2a] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.fastpaxos.Phase2a = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.fastpaxos.Phase2a] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = FastPaxosProto.javaDescriptor.getMessageTypes.get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = FastPaxosProto.scalaDescriptor.messages(4)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = frankenpaxos.fastpaxos.Phase2a(
    round = 0
  )
  implicit class Phase2aLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.fastpaxos.Phase2a]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.fastpaxos.Phase2a](_l) {

...
final case class Phase2b(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.fastpaxos.Phase2b = {
    ...
    def companion = frankenpaxos.fastpaxos.Phase2b
}

object Phase2b extends scalapb.GeneratedMessageCompanion[frankenpaxos.fastpaxos.Phase2b] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.fastpaxos.Phase2b] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.fastpaxos.Phase2b = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.fastpaxos.Phase2b] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = FastPaxosProto.javaDescriptor.getMessageTypes.get(5)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = FastPaxosProto.scalaDescriptor.messages(5)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = frankenpaxos.fastpaxos.Phase2b(
    acceptorId = 0,
    round = 0
  )
  implicit class Phase2bLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.fastpaxos.Phase2b]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.fastpaxos.Phase2b](_l) {

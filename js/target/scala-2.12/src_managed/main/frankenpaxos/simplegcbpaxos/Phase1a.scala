...
final case class Phase1a(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.simplegcbpaxos.Phase1a = {
    ...
    def withVertexId(__v: frankenpaxos.simplegcbpaxos.VertexId): Phase1a = copy(vertexId = __v)
    ...
    def companion = frankenpaxos.simplegcbpaxos.Phase1a
}

object Phase1a extends scalapb.GeneratedMessageCompanion[frankenpaxos.simplegcbpaxos.Phase1a] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.simplegcbpaxos.Phase1a] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.simplegcbpaxos.Phase1a = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.simplegcbpaxos.Phase1a] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SimpleGcBPaxosProto.javaDescriptor.getMessageTypes.get(13)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SimpleGcBPaxosProto.scalaDescriptor.messages(13)
  ...
  lazy val defaultInstance = frankenpaxos.simplegcbpaxos.Phase1a(
    vertexId = frankenpaxos.simplegcbpaxos.VertexId.defaultInstance,
    round = 0
  )
  implicit class Phase1aLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.simplegcbpaxos.Phase1a]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.simplegcbpaxos.Phase1a](_l) {

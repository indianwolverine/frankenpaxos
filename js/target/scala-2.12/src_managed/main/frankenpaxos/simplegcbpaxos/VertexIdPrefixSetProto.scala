...
final case class VertexIdPrefixSetProto(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.simplegcbpaxos.VertexIdPrefixSetProto = {
    ...
    def companion = frankenpaxos.simplegcbpaxos.VertexIdPrefixSetProto
}

object VertexIdPrefixSetProto extends scalapb.GeneratedMessageCompanion[frankenpaxos.simplegcbpaxos.VertexIdPrefixSetProto] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.simplegcbpaxos.VertexIdPrefixSetProto] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.simplegcbpaxos.VertexIdPrefixSetProto = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.simplegcbpaxos.VertexIdPrefixSetProto] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SimpleGcBPaxosProto.javaDescriptor.getMessageTypes.get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SimpleGcBPaxosProto.scalaDescriptor.messages(6)
  ...
  lazy val defaultInstance = frankenpaxos.simplegcbpaxos.VertexIdPrefixSetProto(
    numLeaders = 0
  )
  implicit class VertexIdPrefixSetProtoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.simplegcbpaxos.VertexIdPrefixSetProto]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.simplegcbpaxos.VertexIdPrefixSetProto](_l) {

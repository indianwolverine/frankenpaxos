...
final case class Phase2b(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.simplegcbpaxos.Phase2b = {
    ...
    def withVertexId(__v: frankenpaxos.simplegcbpaxos.VertexId): Phase2b = copy(vertexId = __v)
    ...
    def companion = frankenpaxos.simplegcbpaxos.Phase2b
}

object Phase2b extends scalapb.GeneratedMessageCompanion[frankenpaxos.simplegcbpaxos.Phase2b] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.simplegcbpaxos.Phase2b] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.simplegcbpaxos.Phase2b = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.simplegcbpaxos.Phase2b] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SimpleGcBPaxosProto.javaDescriptor.getMessageTypes.get(16)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SimpleGcBPaxosProto.scalaDescriptor.messages(16)
  ...
  lazy val defaultInstance = frankenpaxos.simplegcbpaxos.Phase2b(
    vertexId = frankenpaxos.simplegcbpaxos.VertexId.defaultInstance,
    acceptorId = 0,
    round = 0
  )
  implicit class Phase2bLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.simplegcbpaxos.Phase2b]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.simplegcbpaxos.Phase2b](_l) {

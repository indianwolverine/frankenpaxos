...
final case class Phase1b(
    ...
    voteValue: scala.Option[frankenpaxos.caspaxos.IntSet] = None
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): frankenpaxos.caspaxos.Phase1b = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 34 =>
            __voteValue = Option(_root_.scalapb.LiteParser.readMessage(_input__, __voteValue.getOrElse(frankenpaxos.caspaxos.IntSet.defaultInstance)))
    ...
    def getVoteValue: frankenpaxos.caspaxos.IntSet = voteValue.getOrElse(frankenpaxos.caspaxos.IntSet.defaultInstance)
    def clearVoteValue: Phase1b = copy(voteValue = None)
    def withVoteValue(__v: frankenpaxos.caspaxos.IntSet): Phase1b = copy(voteValue = Option(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => voteValue.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion = frankenpaxos.caspaxos.Phase1b
}

object Phase1b extends scalapb.GeneratedMessageCompanion[frankenpaxos.caspaxos.Phase1b] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[frankenpaxos.caspaxos.Phase1b] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): frankenpaxos.caspaxos.Phase1b = {
    ...
    frankenpaxos.caspaxos.Phase1b(
      ...
      __fieldsMap.get(__fields.get(3)).asInstanceOf[scala.Option[frankenpaxos.caspaxos.IntSet]]
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[frankenpaxos.caspaxos.Phase1b] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      frankenpaxos.caspaxos.Phase1b(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).flatMap(_.as[scala.Option[frankenpaxos.caspaxos.IntSet]])
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = CasPaxosProto.javaDescriptor.getMessageTypes.get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = CasPaxosProto.scalaDescriptor.messages(3)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 4 => __out = frankenpaxos.caspaxos.IntSet
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = frankenpaxos.caspaxos.Phase1b(
    round = 0,
    acceptorIndex = 0,
    voteRound = 0
  )
  implicit class Phase1bLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.caspaxos.Phase1b]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, frankenpaxos.caspaxos.Phase1b](_l) {
    ...
    def voteValue: _root_.scalapb.lenses.Lens[UpperPB, frankenpaxos.caspaxos.IntSet] = field(_.getVoteValue)((c_, f_) => c_.copy(voteValue = Option(f_)))
    def optionalVoteValue: _root_.scalapb.lenses.Lens[UpperPB, scala.Option[frankenpaxos.caspaxos.IntSet]] = field(_.voteValue)((c_, f_) => c_.copy(voteValue = f_))
  }
